...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/shrill-firefly-685b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-firefly-685b
```

A live public deployment of this template is available at [https://shrill-firefly-685b.templates.workers.dev](https://shrill-firefly-685b.templates.workers.dev)
